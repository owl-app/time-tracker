...
import { TEST_BASE_ENTITIES_CREATED, TEST_SIMPLE_ENTITIES_CREATED } from './data/tes-base-entity.data';
...
import { TEST_BASE_RELATION_ASSIGNED, TEST_BASE_RELATION_CREATED } from './data/test-base-relation.data';
